...
#
# create_project.tcl: Tcl script for re-creating project 'ArtyZ7-SPI-GPIO-HW'
#
# Generated by Vivado on Tue Feb 08 18:27:21 +0100 2022
...
#
#    "C:/Users/Juergen/Documents/Projects/FPGA/Arty-Z7/ArtyZ7-SPI-GPIO-HW/proj/ArtyZ7-SPI-GPIO-HW.srcs/utils_1/imports/synth_1/Periphery_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/Juergen/Documents/Projects/FPGA/Arty-Z7/ArtyZ7-SPI-GPIO-HW/src/bd/Periphery/hdl/Periphery_wrapper.vhd"
#    "C:/Users/Juergen/Documents/Projects/FPGA/Arty-Z7/ArtyZ7-SPI-GPIO-HW/src/constraints/periphery.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/ArtyZ7-SPI-GPIO-HW.srcs/utils_1/imports/synth_1/Periphery_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../src/bd/Periphery/hdl/Periphery_wrapper.vhd"]"\
 "[file normalize "$origin_dir/../src/constraints/periphery.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "ArtyZ7-SPI-GPIO-HW"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../../../../../Xilinx/XilinxBoardStore-2021.2"]" -objects $obj
...
set file "$origin_dir/../src/bd/Periphery/hdl/Periphery_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "Periphery_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../src/constraints/periphery.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../src/constraints/periphery.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../src/constraints/periphery.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../src/constraints/periphery.xdc"]" -objects $obj
...
set file "synth_1/Periphery_wrapper.dcp"
...
# Proc to create BD Periphery
proc cr_bd_Periphery { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name Periphery
  ...
  set BtnIn [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 BtnIn ]
  ...
  set LEDOut [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 LEDOut ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports BtnIn] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports LEDOut] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-490,-702",
   "ExpandedHierarchyInLayout":"",
   "PinnedPorts":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS-threadsafe
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1290 -y -300 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1290 -y -280 -defaultsOSRD
preplace port BtnIn -pg 1 -lvl 4 -x 1290 -y 580 -defaultsOSRD
preplace port LEDOut -pg 1 -lvl 4 -x 1290 -y 600 -defaultsOSRD
preplace port IIC_0 -pg 1 -lvl 4 -x 1290 -y -260 -defaultsOSRD
preplace port port-id_SPI0_SCLK_O_0 -pg 1 -lvl 4 -x 1290 -y -200 -defaultsOSRD
preplace port port-id_SPI0_MISO_I_0 -pg 1 -lvl 0 -x -50 -y -100 -defaultsOSRD
preplace port port-id_SPI0_MOSI_O_0 -pg 1 -lvl 4 -x 1290 -y -140 -defaultsOSRD
preplace port port-id_SPI0_SS_O_0 -pg 1 -lvl 4 -x 1290 -y -20 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 420 -y -90 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 1150 -y 600 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 840 -y 580 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -x 840 -y 290 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -20 180 620 460 1010
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 630 120n
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 650 450 1020
preplace netloc axi_gpio_0_ip2intc_irpt 1 0 4 -10 190 NJ 190 NJ 190 1270
preplace netloc processing_system7_0_SPI0_SCLK_O 1 1 3 NJ -200 NJ -200 NJ
preplace netloc SPI0_MISO_I_0_1 1 0 2 -30J -360 620
preplace netloc processing_system7_0_SPI0_MOSI_O 1 1 3 NJ -140 NJ -140 NJ
preplace netloc processing_system7_0_SPI0_SS_O 1 1 3 NJ -20 NJ -20 NJ
preplace netloc processing_system7_0_DDR 1 1 3 N -300 N -300 N
preplace netloc processing_system7_0_FIXED_IO 1 1 3 N -280 N -280 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 640J 80n
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 NJ 580
preplace netloc axi_gpio_0_GPIO 1 3 1 N 580
preplace netloc axi_gpio_0_GPIO2 1 3 1 N 600
preplace netloc processing_system7_0_IIC_0 1 1 3 N -260 N -260 N
levelinfo -pg 1 -50 420 840 1150 1290
pagesize -pg 1 -db -bbox -sgen -210 -640 1450 700
"
}
...
# End of cr_bd_Periphery()
cr_bd_Periphery ""
set_property REGISTERED_WITH_MANAGER "1" [get_files Periphery.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files Periphery.bd ] 
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/ArtyZ7-SPI-GPIO-HW.srcs/utils_1/imports/synth_1/Periphery_wrapper.dcp" -objects $obj
